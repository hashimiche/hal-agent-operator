# hal-k8s-operator - AI Agent Guide

> **Product / CR / phase design:** read [`LLM_CONTEXT.md`](LLM_CONTEXT.md) first.
> Narrative architecture: [`docs/operator-architecture.md`](docs/operator-architecture.md).
